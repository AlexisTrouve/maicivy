...
// buildMotivationPromptFR_v2 : prompt français v2 — hook + mirror vocab + freelance economics + empathie
...
`, truncated)
		objet = "Candidature au poste mentionné dans l'offre d'emploi"
		// Instruction mirror vocab activée seulement si offre présente
...
MUNITIONS FREELANCE (à intégrer naturellement dans le paragraphe MOI ou NOUS — pas toutes, choisir 1-2 selon le contexte) :
...
L'objectif : convertir une offre CDI en mission freelance. Chaque argument doit servir LEUR intérêt, pas vanter le statut freelance.
...
STRUCTURE À SUIVRE (Vous → Moi → Nous) :
• VOUS (1 paragraphe) : La PREMIÈRE PHRASE doit nommer leur problème business précis — une observation qui montre qu'on a réfléchi à LEUR contexte, pas une intro générique. Le reste du paragraphe développe leur situation dans leurs mots. Zéro "je" dans ce paragraphe.
• MOI (1-2 paragraphes) : 1-2 réalisations concrètes avec chiffres, directement liées à LEUR besoin. 1 projet pertinent nommé précisément. L'argument freelance le plus pertinent (économique, flexibilité ou risque) intégré naturellement — pas listé.
• NOUS (1 paragraphe court) : proposition concrète de mission, durée indicative, CTA à faible friction ("30 minutes cette semaine ?")
...
- Zero employer taxes (~30-40%% on top of gross salary in most EU countries) — same hiring budget = premium freelance mission
...
Goal: convert a job posting into a freelance mission. Every argument serves THEIR interest, not a pitch for freelancing.
...
3. Which of Alexis's projects or achievements is most relevant for THIS specific case?
4. How to open the FIRST SENTENCE with a concrete observation about THEIR specific situation — not a generic industry statement, a precise fact about their context?
...
STRUCTURE TO FOLLOW (You → Me → Us):
• YOU (1 paragraph): The FIRST SENTENCE must name their specific business problem — an observation showing you thought about THEIR context, not a generic intro. Rest of the paragraph develops their situation in their words. Zero "I" in this paragraph.
• ME (1-2 paragraphs): 1-2 concrete achievements with numbers, directly tied to THEIR need. 1 project named precisely. The most relevant freelance argument (economic, flexibility or risk) woven in naturally — not listed.
• US (1 short paragraph): concrete mission proposal, indicative duration, low-friction CTA ("30 minutes this week?")
